...
<div class="col-md-12">
    <?php 
          echo "<table class='table table-bordered table-hover'><thead><tr><th>Admin ID</th><th>Admin Name</th><th>Admin Email</th><th>Admin Password</th><th>Admin Role</th><th>Edit</th><th>Delete</th></tr></thead><tbody>";
          ...
          echo "<tr>";
            ...
            echo "<td><a href='admins.php?admin_role={$admin_role}&admin_id={$admin_id}'>{$admin_role}</a></td>";
            echo "<td><a href='admins.php?source=edit_admin&edit={$admin_id}'>Edit</a></td>";
            echo "<td><a href='admins.php?delete={$admin_id}'>Delete</a></td>";
          echo "</tr>";
		}
