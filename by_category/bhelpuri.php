      ...
      <?php include('create_carts.php'); ?> 
        ...
        <div class="col-lg-10">
          ...
          <div class="row">
            <?php 
              $query = "SELECT * FROM items WHERE item_category = 'BHELPURI'";
            ...
            <?php
              ...
              ?>
                ...
                <div class="card-footer">
                  <?php 
                    echo "<a href='bycategory.php?source=bhelpuri&item_id={$item_id}' class='btn btn-primary btn-block'>Add To Cart</a>";

                    $_SESSION['pages'] = 'bycategory.php?source=bhelpuri'; 
                   ?>
